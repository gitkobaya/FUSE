...
/** 地形データを分割したものです */
public class TerrainFragment extends Model3D{
    ...
    public TerrainFragment(double startX, double startY, double sizeX, double sizeY, Geometry geo, BasicMaterial mat) {
